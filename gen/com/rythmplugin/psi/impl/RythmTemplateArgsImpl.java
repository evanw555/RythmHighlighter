...
public class RythmTemplateArgsImpl extends ASTWrapperPsiElement implements RythmTemplateArgs {

  public RythmTemplateArgsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RythmVisitor visitor) {
    visitor.visitTemplateArgs(this);
  }
